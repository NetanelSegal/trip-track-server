...
export const sendEmailWithCodeToUser = async (email: string, code: string): Promise<ClientResponse> => {
	try {
		const pathToFile = path.join(__dirname, '..', '..', 'public', 'verify-code.html');
